...
const API_BASE_URL = process.env.API_BASE_URL || 'http://localhost:3001'; //'https://api.2ul.top'
...
export { BASE_URL, API_BASE_URL, CLIENT_URL, API_WRITE_SHRTN_DATA, REDIRECT_DELAY_TIME, API_READ_SHRTN_DATA }